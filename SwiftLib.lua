...
function Library:CreateWindow(Settings)
    ...
    Instance.new("UICorner", TabBorder).CornerRadius = UDim.new(0, 12); Instance.new("UIStroke", TabBorder).Color = Color3.fromRGB(255, 255, 255)
    ...
    Instance.new("UICorner", MenuBorder).CornerRadius = UDim.new(0, 12); Instance.new("UIStroke", MenuBorder).Color = Color3.fromRGB(255, 255, 255)
