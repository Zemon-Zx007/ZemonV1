-- [[ Swift Hub X - PROFESSIONAL LIBRARY V3.2 (ULTIMATE FIX) ]]
-- [[ Fixed: Title, Drag Error, SetColor Error, V3.1 Fixed Elements ]]
...
function Library:CreateWindow(Settings)
    ...
    ScreenGui.Name = "SwiftHubX_Zemon_Fixed_V3.2"; ScreenGui.ResetOnSpawn = false
    ...
    local TabStroke = Instance.new("UIStroke", TabBorder); TabStroke.Thickness = 2; TabStroke.Color = Color3.fromRGB(255, 255, 255)
    ...
    local MenuStroke = Instance.new("UIStroke", MenuBorder); MenuStroke.Thickness = 2; MenuStroke.Color = Color3.fromRGB(255, 255, 255)

    local Header = Instance.new("Frame", MainFrame)
    Header.Size = UDim2.new(1, 0, 0, 40); Header.BackgroundTransparency = 1
    
    -- ** [[ 🔥 เติม Title Label กลับมาแล้ว! 🔥 ]] **
    local TitleLabel = Instance.new("TextLabel", Header)
    TitleLabel.Text = "   " .. Title; TitleLabel.Size = UDim2.new(1, -50, 1, 0); TitleLabel.Position = UDim2.new(0, 0, 0, 0)
    TitleLabel.TextColor3 = Color3.fromRGB(255, 255, 255); TitleLabel.Font = Enum.Font.GothamBold; TitleLabel.TextSize = 15; TitleLabel.TextXAlignment = 0; TitleLabel.BackgroundTransparency = 1

    local EyeBtn = Instance.new("ImageButton", Header)
    EyeBtn.Size = UDim2.new(0, 24, 0, 24); EyeBtn.Position = UDim2.new(1, -35, 0.5, -12); EyeBtn.BackgroundTransparency = 1; EyeBtn.Image = "rbxassetid://10709810534"; EyeBtn.ImageColor3 = Color3.fromRGB(255, 255, 255)
    ...
    function WindowAPI:Notify(Msg)
        ...
        Instance.new("UICorner", f); local Stroke = Instance.new("UIStroke", f); Stroke.Color = Color3.fromRGB(255,255,255)
        local t = Instance.new("TextLabel", f); t.Text = Msg; t.Size = UDim2.new(1,0,1,0); t.TextColor3 = Color3.fromRGB(255,255,255); t.BackgroundTransparency = 1; t.TextSize = 13
    ...
    function WindowAPI:SetColor(NewColor)
        ...
        -- ** [[ แก้ไข SetColor: เปลี่ยนสีได้ 100% ไร้ Error! ]] **
    ...
    function WindowAPI:ChangeLanguage(LangTable)
        ...
        for _, v in pairs(WindowAPI.AllTabs) do if LangTable[v.ID] then task.spawn(function() Anim(v.Instance, LangTable[v.ID]) end) end end
    ...
    -- ** [[ 🔥 แก้ไขระบบ Drag: ลบ Error "MouseButton1 is not a valid member of "Enum" 🔥 ]] **
    local function drag(f)
        ...
        -- แก้ไขจุดนี้: ใช้ UserInputService ในการเช็ก MouseButton1End เพื่อความเสถียร
    ...
    function WindowAPI:CreateTab(Name, ID)
        ...
        function El:CreateSection()
            ...
            function Sub:CreateDropdown(T, EID, L, C)
                local d = Instance.new("TextButton", H); d.Size = UDim2.new(1, 0, 0, 35); d.BackgroundColor3 = Color3.fromRGB(22, 22, 22); d.Text = "  " .. T .. ": None"; d.TextColor3 = Color3.fromRGB(200, 200, 200)
                ...
                Instance.new("UIListLayout", df); Instance.new("UICorner", df).CornerRadius = UDim.new(0, 8)
            ...
            function Sub:CreateCodeBox()
                ...
                Instance.new("UICorner", Box).CornerRadius = UDim.new(0, 10); table.insert(WindowAPI.CodeBoxes, Box)
                local txt = Instance.new("TextLabel", Box); txt.Size = UDim2.new(1, -20, 1, -20); txt.Position = UDim2.new(0, 10, 0, 10); txt.BackgroundTransparency = 1; txt.TextColor3 = Color3.fromRGB(0, 255, 150)
                txt.Font = Enum.Font.Code; txt.TextSize = 14; txt.TextXAlignment = Enum.TextXAlignment.Left; txt.TextYAlignment = Enum.TextYAlignment.Top; txt.Text = "📊 Loading Status..."
